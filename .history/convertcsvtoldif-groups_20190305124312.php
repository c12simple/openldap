...
// Create ou:
    ...
    while ((($data = fgetcsv($handle, 1000, ",")) !== FALSE) && ($row <= $limit)){
        ...
        {
            echo "dn: uid=".$data[2].",ou=".$userTypeGroups[$data[4]].",ou=staff,ou=people,dc=example,dc=org\n";
        }else{
        ...
        {
            echo "memberOf: cn=".$userTypeGroupsdepartMent[$data[5]].",ou=groups,dc=example,dc=org\n";
        }
